...
class Robot:
	...
	def playHappyBirthday(self):
		...
		"""
		self.sendCommand(self.song_manager.get_verse_one)
		time.sleep(1.0)
		self.sendCommand(self.song_manager.get_verse_two)\
		
		self.sendCommand(self.song_play_cmd + b'\x01')
		self.sendCommand(self.song_play_cmd + b'\x02')
